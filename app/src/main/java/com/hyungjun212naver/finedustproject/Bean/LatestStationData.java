...
public class LatestStationData {
    ...
    @Expose
    private List<LatestStationData_AirValue> stationData = null;

    public List<LatestStationData_AirValue> getStationData() {
        return stationData;
    }

    public void setStationData(List<LatestStationData_AirValue> stationData) {
        this.stationData = stationData;
    }

    public class LatestStationData_AirValue {
        ...
        public Object getPm25Grade() {
            return pm25Grade;
        }

        public void setPm25Grade(Object pm25Grade) {
            this.pm25Grade = pm25Grade;
        }

        public Object getPm25Value() {
            return pm25Value;
        }

        public void setPm25Value(Object pm25Value) {
